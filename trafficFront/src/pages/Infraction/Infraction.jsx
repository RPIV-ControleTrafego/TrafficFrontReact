  ...
  import Modal from 'react-modal';
    ...
    const downloadCSV = () => {
      ...
      return (
        <div className="App" style={{marginTop:900}}>

          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px', marginTop: 1200}}>
      ...
      >
        <button onClick={closeModal} className='bg-red-500 text-white py-2 px-4 rounded hover:bg-blue-700 mx-auto'>Fechar</button>
        <iframe
      ...
      <button onClick={openModal}  className='bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-700 mx-auto'>Procurar na tabela</button>
